...
func newSetting(db *gorm.DB, opts ...gen.DOOption) setting {
	...
	_setting.Language = field.NewString(tableName, "language")
	_setting.Theme = field.NewString(tableName, "theme")
...
func (s *setting) updateTableName(table string) *setting {
	...
	s.Theme = field.NewString(table, "theme")
